About python-substrait-feedstock
================================
...
pixi add python-substrait
# for installing globally
pixi global install python-substrait
```
...
It is possible to list all of the versions of `python-substrait` available on your platform:
...
```
pixi search python-substrait --channel conda-forge
```
